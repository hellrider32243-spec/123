...
PUBLIC_HOST = _env("GRPC_PUBLIC_HOST", _env("PUBLIC_VLESS_HOST", "107.189.24.59"))
...
AMS_HOST = _env("AMS_HOST", "107.189.24.59")
...
_DEFAULT_HY2_HOST = f"wingsvpn.{AMS_HOST}.sslip.io" if AMS_HOST else "wingsvpn.107.189.24.59.sslip.io"
